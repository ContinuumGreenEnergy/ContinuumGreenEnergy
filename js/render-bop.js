...
function open33ProgressForm(){
  ...
  document.getElementById('p-b').innerHTML=`<form onsubmit="submit33Progress(event)">
    ...
    <div class="fg" style="font-size:9px;color:var(--t3);">Current value: <b id="p33-cur" style="color:var(--ac);">—</b></div>
...
// Show the current stored % for the selected feeder+activity
...
async function submit33Progress(e){
  ...
  cov('pov');
  if(typeof showToast==='function') showToast('✅ 33kV '+fk+' · '+actName+' → '+pct+'%','ok');
