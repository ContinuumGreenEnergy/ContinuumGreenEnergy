...
async function submit33Progress(e){
  ...
  cov('pov');
  if(typeof showToast==='function') showToast('✅ 33kV '+fk+' · Poles '+DB.bop33lines[fk].poleDone+'/'+DB.bop33lines[fk].poleTotal+' · Spans '+DB.bop33lines[fk].spanDone+'/'+DB.bop33lines[fk].spanTotal,'ok');
