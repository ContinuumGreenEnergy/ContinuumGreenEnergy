...
function podTab(t){
  ...
  el.innerHTML=`
    <div class="pnl" style="position:relative;">
      ...
      <div class="al al-i" style="margin-bottom:9px;">ℹ️ POD = Planned work for today (no login). Status updates (Not Started → WIP → Completed) require the authorised person to unlock edits.</div>
      ${entries.length
