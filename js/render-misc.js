...
function rndrMp(){
  ...
  document.getElementById('mp-ct').innerHTML=`${_pageLogoTR()}
    ...
    <!-- Summary KPI strip (live, for selected date) -->
    <div class="kr">
      <div class="kpi"><div class="kb" style="background:var(--ac)"></div><div class="kl">Total Manpower</div><div class="kv" style="color:var(--ac)">${totMp}</div></div>
      <div class="kpi"><div class="kb" style="background:var(--sol)"></div><div class="kl">Solar</div><div class="kv" style="color:var(--sol)">${sol.manpower}</div></div>
      <div class="kpi"><div class="kb" style="background:var(--wtg)"></div><div class="kl">WTG</div><div class="kv" style="color:var(--wtg)">${wtg.manpower}</div></div>
      <div class="kpi"><div class="kb" style="background:var(--bop)"></div><div class="kl">BOP</div><div class="kv" style="color:var(--bop)">${bop.manpower}</div></div>
      <div class="kpi"><div class="kb" style="background:var(--land)"></div><div class="kl">Land</div><div class="kv" style="color:var(--land)">${land.manpower}</div></div>
      <div class="kpi"><div class="kb" style="background:var(--wn)"></div><div class="kl">Machinery Units</div><div class="kv" style="color:var(--wn)">${totMachineUnits}</div></div>
    </div>
