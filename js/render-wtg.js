...
function selectZeroPoint(containerId){
  ...
  // Pick the container by current view: the standalone Zero Point view uses
  // 'zp-body'; inside the WTG view the right detail panel is used. This stops
  // ZP content from being written into a view it doesn't belong to.
  const target = containerId || (CV === 'zp' ? 'zp-body' : 'wtg-right-panel');
